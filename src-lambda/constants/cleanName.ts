...
export const cleanName = (name: string) => {
  const lookup: { [key: string]: string[] } = {
    Abdul: [],
    Adam: ["Adam 🦜 x", "Adam 🦤 x", "Adam 🍩 x", "Adam 🦜 x", "Adam ⚾️ x"],
    Adel: [
      "El Maestro 👁️ x",
      "Adel 👁 x",
      "Adel 👁️ x",
    ...
    Tom: ["Big ChaTomgus 🌴 x"],
    "Big Chris": ["OG Chris 😎"],
    Bella: ["Bella 🧜‍♀️ x", "Bella x / Katy x"],
    Berkeley: ["Berkeley x"],
    Bill: ["Bill"],
    Brett: ["Brett x"],
    Blake: [],
    ...
    Campbell: ["Campbell 🤠 x", "Campbell 🧑‍⚖️🐟 x", "Campbell x", "Campbell🦈"],
    Carter: ["Carter x"],
    Chahrazef: [],
    Charlie: [],
    Cho: ["Cho x", "Cho 👸🏻"],
    "Chris M": ["Chris 🩴 x", "Chris"],
    "Chris H": ["Chris H x"],
    Claire: [],
    Conor: ["Conner", "Conor x"],
    Dan: ["Dan x"],
    Darren: ["Darren x 🐢", "Darren 🐢 x", "Darren x / Luis x"],
    David: [],
    Derek: ["Derek 🪤 x	", "Derek x / Aqeel x", "Derrick x", "Derrick"],
    "Derek T": [],
    Doug: ["Doug x"],
    Dylan: ["Dylan x"],
    Eddie: ["Eddie x", "Fast Eddie x"],
    Edward: [],
    Enrique: [],
    Eric: ["Eric x"],
    ...
    Ken: ["Ken 💀 x", "Ken 💀x"],
    Lauren: ["Lauren x"],
    Lily: ["Medusa 🧟‍♀️ x", "Lily x", "Lillies 🫘"],
    Lisa: [],
    Luis: ["Luis x", "Luis 🦖 x", "Luis Vuitton 🦖 x"],

    Malcolm: [],
    Marcus: [],
    Mariel: ["Mariel / Ykaalo x"],
    Martin: [
    ...
    Philo: [],
    Ricky: ["Ricky x"],
    Riley: ["Riley", "Riley x / Brendan x"],
    Robin: [],
    Ronnie: ["Ronnie", "Ronny", "Ronny x", "Ronnie x / Spencer x"],
    Ryan: [],
    Said: [],
    Salem: ["Salem / Marty x"],
    Sean: ["Sean 🖕 x", "Sean 👍 x", "Sean 🎼 x", "S69"],
    Shawn: ["Shawn 😈 x"],
    Sirine: ["Sirine 🐠🦋 x", "Sirine x / Adel x", "Adel / Sirine"],

    Spencer: ["Herrerasaurus", "Spence"],
    Rachelle: ["Rachelle 📢 x"],
    Ray: ["Ray 🐍 x"],
    Sup: ["Sup 🐐 x"],
    Tef: ["Teff 😈"],
  ...
  const updateRank = (newName: string, newStrength: number) => {
    if (newStrength > rankTracker.strength) {
      ...
      console.warn(
        `Warning - unable to disambiguate mapping input "${name}" to cleaned name "${newName}" or "${rankTracker.cleanName}}"`
      );
    }
  };
